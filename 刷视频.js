...
if(className("android.widget.TextView").text("开宝箱").exists()){
    ...
    function 限时任务() {
    className("android.view.View").desc("限时任务赚金币").findOne(60*1000).click();
    log("限时任务")
    sleep(3000)
    }
    function 划屏() {
    ...
    function 开宝箱() {
    className("android.view.View").desc("开宝箱得金币").findOne(60*1000).parent().click();  
    toast("开宝箱")    
    log("点击开宝箱");    
    sleep(2000)
    className("android.view.View").desc("看广告视频再赚").findOne(60*1000).click();
    log("二重") 
    sleep(3000)   
    className("android.view.View").desc("已领取").findOne(60*1000);
    sleep(3000)
    }
    function 金币农场(){
        home()
